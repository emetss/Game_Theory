...
class ZeroSumGame(object):
    ...
    def fictitiousPlay (self, epsilon_1, epsilon_2):
        ...
        temp_empirical_mixed_strategy_i=counter_i_strategy
        temp_empirical_mixed_strategy_minusi=counter_minusi_strategy
        difference_1=5
        difference_2=5


        while difference_1>epsilon_1 and difference_2>epsilon_2:
            counter+=1
        ...
        self.nash_equilibrium=[empirical_mixed_strategy_i, 1-empirical_mixed_strategy_i, 1-empirical_mixed_strategy_minusi, empirical_mixed_strategy_minusi]
